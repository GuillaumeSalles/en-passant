...
export function VariationTraining(props: { repertoireHandle: string; chapterHandle: string }) {
  ...
  return (
    <Show when={chapterPgn() !== undefined} fallback={null}>
      <Layout
        title={
          <div class="min-w-0 truncate text-base font-medium">
            {repertoireName()} - Variation {training().variationIndex + 1} /{" "}
            {variationEnds().length}
          </div>
        }
        chessboard={
          <Chessboard
        ...
        panelChildren={
          <>
            ...
            <HorizontalDashedDivider animationKey="variation-training-instructions-top" />
            ...
            <HorizontalDashedDivider animationKey="variation-training-moves" />
            <MovesTree />
            <PgnExplorerToolbar />
          </>
        }
