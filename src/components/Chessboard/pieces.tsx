// Based on Cburnett's Wikimedia Commons SVG chess pieces, licensed GPL-2.0-or-later.
...
type PieceProps = {
  ...
  fill?: string;
  svgProps?: JSX.SvgSVGAttributes<SVGSVGElement> & DataAttributes;
};
...
export const defaultPieces = {
  P: (props: PieceProps) => (
    <svg
      ...
      version="1.1"
      viewBox="0 0 45 45"
      class={props.svgProps?.class}
      style={props.svgProps?.style}
      data-moving-piece={props.svgProps?.["data-moving-piece"]}
      data-moving-piece-id={props.svgProps?.["data-moving-piece-id"]}
      data-captured-piece={props.svgProps?.["data-captured-piece"]}
      data-captured-piece-square={props.svgProps?.["data-captured-piece-square"]}
      data-promoted-piece={props.svgProps?.["data-promoted-piece"]}
      data-promoted-piece-square={props.svgProps?.["data-promoted-piece-square"]}
      data-board-animation-part={props.svgProps?.["data-board-animation-part"]}
    >
      <path
  ...
  B: (props: PieceProps) => (
    ...
    >
      ...
      >
        <g style={{ fill: props?.fill ?? "#ffffff", stroke: "#000000", "stroke-linecap": "butt" }}>
  ...
  b: (props: PieceProps) => (
    ...
    >
      ...
      >
        <g style={{ fill: props?.fill ?? "#000000", stroke: "#000000", "stroke-linecap": "butt" }}>
          <path d="M 9,36 C 12.39,35.03 19.11,36.43 22.5,34 C 25.89,36.43 32.61,35.03 36,36 C 36,36 37.65,36.54 39,38 C 38.32,38.97 37.35,38.99 36,38.5 C 32.61,37.53 25.89,38.96 22.5,37.5 C 19.11,38.96 12.39,37.53 9,38.5 C 7.65,38.99 6.68,38.97 6,38 C 7.35,36.54 9,36 9,36 z" />
          <path d="M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,30 30,30 C 30,27.5 27.5,26 27.5,26 C 33,24.5 33.5,14.5 22.5,10.5 C 11.5,14.5 12,24.5 17.5,26 C 17.5,26 15,27.5 15,30 C 15,30 14.5,30.5 15,32 z" />
          <path d="M 25 8 A 2.5 2.5 0 1 1  20,8 A 2.5 2.5 0 1 1  25 8 z" />
        </g>
    ...
    >
      ...
      >
        <path
          ...
          style={{ "stroke-linecap": "butt", fill: props?.fill ?? "#000000" }}
        />
